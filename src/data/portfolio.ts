...
export const skills = [
  { title: "React Native", level: 95, group: "Mobile" },
  { title: "Kotlin / Android", level: 90, group: "Mobile" },
  { title: "JavaScript / TS", level: 92, group: "Language" },
  { title: "Java", level: 80, group: "Language" },
  { title: "Firebase", level: 88, group: "Backend" },
  { title: "REST APIs", level: 90, group: "Backend" },
  { title: "Node.js", level: 75, group: "Backend" },
  { title: "MongoDB", level: 72, group: "Backend" },
  { title: "Redux", level: 85, group: "State" },
  { title: "MVVM / Hilt", level: 85, group: "Architecture" },
